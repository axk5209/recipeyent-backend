...
loginRouter.post('/', async (request, response) => {
	...
	const user = await User.findOne({ username: body.username }) //Only need to populate for what is displayed in list form (User Page and Recipe Page check based on id)
